...
,custom,tempca,tpkanban,kanban,kanbanimg,ext='.gif',old,purl,dessert,dessertlevel,dessertname,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,w1,w2,w3,w4,w5,c1,c2,c3,c4,c5,c6,c7,h1,h2,h3,spinert,nowEquip,spineJson,tch,yourcard,cardvo,iconsize,equipName,kbw,kbh,shapes
...
function usTheme(UserJSON){
    ...
    if(!nowTheme.a1)nowTheme.a1=originTheme.a1;
    nowTheme.a2[3]=equipName[1];nowTheme.a3[3]=equipName[2];nowTheme.a4[3]=equipName[3];nowTheme.a5[3]=equipName[4];nowTheme.a6[3]=equipName[5];
    nowTheme.a7[3]=equipName[6];nowTheme.a8[3]=equipName[7];nowTheme.ao8[3]=equipName[8];nowTheme.a9[3]=equipName[9];nowTheme.a10[3]=equipName[10];nowTheme.ao10[3]=equipName[11];
    nowTheme.w1[3]=equipName[12];nowTheme.wo1[3]=equipName[13];nowTheme.w2[3]=equipName[14];nowTheme.w3[3]=equipName[15];nowTheme.wo3[3]=equipName[16];nowTheme.w4[3]=equipName[31];nowTheme.w5[3]=equipName[32];
    nowTheme.c1[3]=equipName[17];nowTheme.c2[3]=equipName[18];nowTheme.c3[3]=equipName[19];nowTheme.c4[3]=equipName[20];nowTheme.c5[3]=equipName[21];nowTheme.c6[3]=equipName[22];nowTheme.co6[3]=equipName[23];nowTheme.c7[3]=equipName[24];
    nowTheme.h1[3]=equipName[25];nowTheme.ho1[3]=equipName[26];nowTheme.h2[3]=equipName[27];nowTheme.ho2[3]=equipName[28];nowTheme.h3[3]=equipName[29];nowTheme.ho3[3]=equipName[30];
    ...
    if(nowTheme.ext)ext=nowTheme.ext;purl=nowTheme.url;dessert=nowTheme.dessert;old=nowTheme.old;dessertlevel=nowTheme.dessertlevel;dessertname=nowTheme.dessertname;
    a1=nowTheme.a1;a2=nowTheme.a2;a3=nowTheme.a3;a4=nowTheme.a4;a5=nowTheme.a5;a6=nowTheme.a6;a7=nowTheme.a7;a8=nowTheme.a8;a9=nowTheme.a9;a10=nowTheme.a10;
    w1=nowTheme.w1;w2=nowTheme.w2;w3=nowTheme.w3;w4=nowTheme.w4;w5=nowTheme.w5;
    c1=nowTheme.c1;c2=nowTheme.c2;c3=nowTheme.c3;c4=nowTheme.c4;c5=nowTheme.c5;c6=nowTheme.c6;c7=nowTheme.c7;
    h1=nowTheme.h1;h2=nowTheme.h2;h3=nowTheme.h3;
...
function theEqName(){
    $("button[data-original-title]").attr("data-original-title",function(n,v){
        n= v.replace(/探险者之剑/g,a1[3]).replace(/探险者短弓/g,a2[3]).replace(/探险者短杖/g,a3[3]).replace(/狂信者的荣誉之刃/g,a4[3]).replace(/反叛者的刺杀弓/g,a5[3])
            .replace(/幽梦匕首/g,a6[3]).replace(/光辉法杖/g,a7[3]).replace(/荆棘盾剑/g,a8[3]).replace(/陨铁重剑/g,a9[3]).replace(/饮血魔剑/g,a10[3])
            .replace(/探险者手环/g,w1[3]).replace(/命师的传承手环/g,w2[3]).replace(/秃鹫手环/g,w3[3]).replace(/海星戒指/g,w4[3]).replace(/噬魔戒指/g,w5[3])
            .replace(/探险者铁甲/g,c1[3]).replace(/探险者皮甲/g,c2[3]).replace(/探险者布甲/g,c3[3]).replace(/旅法师的灵光袍/g,c4[3]).replace(/战线支撑者的荆棘重甲/g,c5[3])
            .replace(/复苏战衣/g,c6[3]).replace(/挑战斗篷/g,c7[3])
            .replace(/探险者耳环/g,h1[3]).replace(/占星师的耳饰/g,h2[3]).replace(/萌爪耳钉/g,h3[3])
            .replace(/紫晶樱桃护身符/g, dessertname[2]).replace(/蓝银葡萄护身符/g, dessertname[1]).replace(/星铜苹果护身符/g, dessertname[0]);
        return n;
    });
    $(".with-padding").html(function(n,v){
        n= v.replace(/探险者之剑/g,a1[3]).replace(/探险者短弓/g,a2[3]).replace(/探险者短杖/g,a3[3]).replace(/狂信者的荣誉之刃/g,a4[3]).replace(/反叛者的刺杀弓/g,a5[3])
            ...
            .replace(/探险者铁甲/g,c1[3]).replace(/探险者皮甲/g,c2[3]).replace(/探险者布甲/g,c3[3]).replace(/旅法师的灵光袍/g,c4[3]).replace(/战线支撑者的荆棘重甲/g,c5[3])
            .replace(/复苏战衣/g,c6[3]).replace(/挑战斗篷/g,c7[3])
            .replace(/探险者耳环/g,h1[3]).replace(/占星师的耳饰/g,h2[3]).replace(/萌爪耳钉/g,h3[3]).replace(/天使缎带/g,h3[3])
            .replace(/星铜苹果护身符/g,dessertname[0]).replace(/蓝银葡萄护身符/g,dessertname[1]).replace(/紫晶樱桃护身符/g,dessertname[2]);
        return n;
    });
};
function themeIcon(){
    ...
    $("button[style*='ys/icon/z/z9']").attr("style",function(n,v){
        n= v.replace(/ys\/icon\/z\/z901/g, purl+dessert[2]).replace(/ys\/icon\/z\/z902/g, purl+dessert[1]).replace(/ys\/icon\/z\/z903/g, purl+dessert[0]);
        return n;
    });
...
function getCardName(){
    let imgpanel,cardname; yourcard=custom.yourcard; tempca="舞"; tempvo=false;
    ...
    if($("#eqli2.active").length==1){
        if($("#bigcardimg").length==0&&custom.showCG&&!nowTheme.nofgimg){ $(`<p></p><img id="bigcardimg" src="https://sticker.inari.site/null.gif">`).insertBefore("#backpacks"); };
...
function themeVoice(type,cardname){
    if(custom.voiceO&&!nowTheme.novoice){
        let playvo=cardvo;
        ...
        if(type=="exp")$("#themeSoundPlay").attr('src',playvo[0]+'levelup'+playvo[1]);
        if(type=="on")$("#themeSoundPlay").attr('src',nowTheme.voice[0]);
        if(type=="win"){
            $("#themeSoundPlay").attr('src',playvo[0]+'win'+playvo[1]);
            $("#themeSoundPlay")[0].addEventListener('ended', function(){ $("#themeSoundPlay")[0].play(); });
        }
        else if(type=="lose"){
            $("#themeSoundPlay").attr('src',playvo[0]+'lose'+playvo[1]);
            $("#themeSoundPlay")[0].addEventListener('ended', function(){ $("#themeSoundPlay")[0].play(); });
        }
        else if(!ccard){ $("#themeSoundPlay")[0].play(); };
    }
...
function themeBattle(){
    ...
    if($("button[class*='fyg_colpz05bg'][style*='b4.gif']").length>0&&collecheck<1){
        ...
        ++collecheck; themeVoice("exp",expcard[5]);
    };
};
...
function playAnimation(animation){
  if(custom.showKanban==true&&!nowTheme.nospine){
    ...
    if (confirm(lang.themeSW)) {
        ...
        if (ThemePack) {
            if(ThemePack=="0"){ console.log('off');custom.ThemePack="off"; update();location.reload();}
                ...
                alert("由于重构问题，自定义主题包功能暂时不可用，默认将使用经典主题，请等待更新！");
                console.log('test');custom.ThemePack="test"; update();location.reload();
                /*
